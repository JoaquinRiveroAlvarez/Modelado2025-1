...
namespace Proyecto2025.Server.Controllers
{
    ...
    //    public async Task<ActionResult<List<TipoProducto>>> GetList()
    //    {
    //        var lista = await context.TipoProductos.ToListAsync();
    //        if (lista == null)
    //        {
    ...
    //    {
    //        var tipoProvincia = await context.TipoProductos.FirstOrDefaultAsync(x => x.Id == id);
    ...
    //    [HttpGet("codigo/{cod}")]  //GET api/TipoProducto/cod/PRU
    //    public async Task<ActionResult<TipoProducto>> GetByCod(string cod)
    //    {
    //        var tipoProvincia = await context.TipoProductos.FirstOrDefaultAsync(x => x.CodTipoProducto == cod);
    //        if (tipoProvincia is null)
    //        {
    ...
    //    [HttpPost]
    //    public async Task<ActionResult<int>> Post(TipoProducto DTO)
    //    {
    //        try
    //        {                
    //            await context.TipoProductos.AddAsync(DTO);
    ...
    //    public async Task<ActionResult> Put(int id, TipoProducto DTO)
    //    {
    //        if (id != DTO.Id)
    //        {
    ...
    //            return NotFound($"No existe el tipo de provincia con el id: {id}.");
    //        }
    //        context.TipoProductos.Remove(tipoProvincia);
    //        await context.SaveChangesAsync();
